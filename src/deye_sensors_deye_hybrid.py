...
deye_hybrid_battery_178 = SingleRegisterSensor(
    "Total Power", 178, 1, mqtt_topic_suffix="total power", unit="W", signed=False, groups=["deye_hybrid_battery"]
)
